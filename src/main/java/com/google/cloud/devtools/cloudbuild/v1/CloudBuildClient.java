...
public class CloudBuildClient implements BackgroundResource {
  public  CloudBuildSettings settings;      //removed private final from here
  public  CloudBuildStub stub;
  public  OperationsClient httpJsonOperationsClient;
  public  com.google.longrunning.OperationsClient operationsClient;

  /** Constructs an instance of CloudBuildClient with default settings. */
  public static CloudBuildClient create() throws IOException {
   ...
   */
  public static CloudBuildClient create(CloudBuildSettings settings) throws IOException {
   ...
   */
  public static CloudBuildClient create(CloudBuildStub stub) {
   ...
   */
  public CloudBuildClient(CloudBuildSettings settings) throws IOException {
  ...
  public  CloudBuildSettings getSettings() 
  {
    return settings;
  }
